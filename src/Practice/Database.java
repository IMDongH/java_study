...
public class Database {
    ...
    boolean joinCheck(String _id, String _password, String _nickname, String _email, String _personer_link,String _name) {
        ...
        try {
            ...
            String insertStr = "INSERT INTO guest VALUES('" + id + "', '" + password + "', '" + nickname + "', '" + email + "', '" + personer_link + "', 0, 0,0,'','" + name + "')";
    ...
    boolean overCheck(String _att, String _val) {
        boolean flag = false;    //참거짓을 반환할 flag 변수. 초기값은 false
        ...
        try {
            //guest 테이블에 존재하는 아이디(혹은 닉네임)를 모두 찾는다.
            String selcectStr = "SELECT " + att + " FROM guest";
    ...
    ResultSet viewInfo(String _nn) {
        ...
        try {
            //guest 테이블에서 nick이라는 닉네임을 가진 회원의 이름과 이메일 정보를 조회한다.
    ...
    boolean drawRecord(String _nn) {
        ...
        //매개변수로 받은 닉네임과 조회한 무 횟수를 저장할 변수. num의 초기값은 0.
        String nick =  _nn;
        int num = 0;

        try {
            //guest 테이블에서 nick이라는 닉네임을 가진 회원의 무 횟수를 조회한다.
